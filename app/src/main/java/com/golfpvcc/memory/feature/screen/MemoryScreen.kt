...
import com.golfpvcc.memory.feature.compoents.BuildButtons
import com.golfpvcc.memory.feature.compoents.GameCard
import com.golfpvcc.memory.feature.compoents.IconButton
import com.golfpvcc.memory.feature.presentation.MemoryEvent
import com.golfpvcc.memory.feature.util.calculateRowRanges
        ...
        Row(
            ...
            for (cardId in range) {
                Box(
                    ...
                    GameCard(card = state.cards[cardId],
                        state = state,
                        modifier = Modifier
                            .padding(6.dp)
                            .fillMaxSize(),
